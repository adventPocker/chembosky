...
const TrackSongs: React.FC<any> = ({ songData }) => {
  const [hoveredIndex, setHoveredIndex] = useState<number | null>(null);
  const [visibleSongData, setVisibleSongData] = useState<FamousTrackSong[]>(
    songData.slice(0, 6)
  );
  ...
  return (
    <>
      <div className=" md:mt-28 mt-20  ">
        ...
        <div className="py-10 ">
          <div className="grid lg:grid-cols-6 md:grid-cols-4 sm:grid-col-3 grid-cols-2 lg:gap-5 gap-3">
            <AnimatePresence>
              {visibleSongData.map((Song: FamousTrackSong, index: number) => (
                <motion.div
                  key={index}
                    ...
                    <div className="custom-card">
                      ...
                      >
                        <Image
                          ...
                          src="/Icons/play2.png"
                          alt="play"
                          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-8 w-8 object-cover object-center"
                          width={32}
                          height={32}
                        ...
                        <div className="custom-back">
                          ...
                          {/* Additional content for more info can be added here */}
                          <div className="flex gap-2 items-center">
                            <a href="https://open.spotify.com/album/3KEn6h4Pr8FJ3vHyS3DfvH">
                              <svg
                              ...
                              >
                                <linearGradient
                                  id="K5582Y0nxj3c5fKX6blGIa_69459_gr1"
                                  x1="32"
                                  x2="32"
                                  y1="6"
                                  y2="58"
                                ...
                                <path
                                  fill="none"
                                  stroke="url(#K5582Y0nxj3c5fKX6blGIa)"
                                  strokeMiterlimit="10"
                                  strokeWidth="2"
                                  d="M32 7A25 25 0 1 0 32 57A25 25 0 1 0 32 7Z"
                                ></path>
                                <linearGradient
                                  id="K5582Y0nxj3c5fKX6blGIb_69459_gr2"
                                  x1="29.5"
                                  x2="29.5"
                                  y1="17"
                                  y2="47"
                      ...
                      <Image  
                        loading="lazy"
                        src={`${BASE_URL}${Song.ThumbImage.url}`}
                        alt={Song.ThumbImage.url}
                        width={177}
                        height={177}
                        className="w-full h-full rounded object-cover transition-transform duration-300 ease-in"
                      />
                    </div>  
                    <div className="mt-5 text-neutral-900 text-base font-medium font-clash-medium leading-normal tracking-tight">
                      {Song.Title}
                    </div>
                    <div className="text-neutral-900 text-sm font-normal font-clash-regular leading-tight tracking-tight md:block hidden">
                      {Song.Singer}
                    </div>
                  </div>
                </motion.div>
